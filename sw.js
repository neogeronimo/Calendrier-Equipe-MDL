const CACHE='calendrier-mdl-v111';
const ASSETS=['./','./index.html','./styles.css?v=111','./app.js?v=111','./config.js','./manifest.webmanifest?v=111','./icons/icon-192.png','./icons/icon-512.png'];
